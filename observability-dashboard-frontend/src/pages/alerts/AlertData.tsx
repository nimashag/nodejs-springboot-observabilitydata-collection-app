...
import { exportToCSV, exportToJSON } from '../../utils/alerts/exportUtils'
import { useApp } from '../../context/AppContext'
import type { Alert } from '../../types/alerts/alert.types'
...
const AlertData = () => {
  ...
  const loadAlerts = async () => {
    try {
      setLoading(true)
      const response = await alertApiService.getAlerts(page, 1000)
